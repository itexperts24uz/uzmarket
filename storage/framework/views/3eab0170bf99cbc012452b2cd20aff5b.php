...
<?php foreach($attributes->onlyProps(['color','disabled','form','formId','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','xCloak','xShow','badge','badgeColor','label','size','badgeColor']) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['color','disabled','form','formId','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','xCloak','xShow','badge','badgeColor','label','size','badgeColor']); ?>
<?php foreach (array_filter((['color','disabled','form','formId','href','icon','iconSize','keyBindings','labelSrOnly','tag','target','tooltip','type','wire:click','wire:target','xOn:click','class','xCloak','xShow','badge','badgeColor','label','size','badgeColor']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php endif; ?><?php /**PATH C:\OSPanel\home\uzmarket.test\storage\framework\views/9a4e1a8a66c8280259d53aacb308b893.blade.php ENDPATH**/ ?>